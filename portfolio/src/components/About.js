        ...
        <div className="w-100 about" id="about">
            <div className="container">
                ...
                <div className="row pt-5">
                    <div className="col-12 col-md-6 col-lg-6 mb-4 center-text" data-aos = "fade-up-right">
                        <div className="aboutImagePart">
                            <img src={Picture} alt="My pic" className="rounded-image"/>
                        </div>
                        <br />                          
                        <div className="mySkills mt-5 mb-5">
                            <p className="mx-3 mb-0" data-aos = "fade-up-right">Tech Skills  | </p>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 aboutTextPart text-white" data-aos = "fade-up-left">
                        <div>
                            ...
                            <br />
                            <div className="mySkills mt-2 mb-3">
                                <h4>UNC Charlotte Bioinformatics</h4>
                            </div>
                            <p>
                                Research Assistant Developer ( Sep 2021 - Dec 2021)
                            </p>
                            <hr className="mt-3"/>
                            <button className="btn download mt-4 mb-0" data-aos="fade-up-left" data-aos-duration="1000" onClick={downloadResume}>Download Resume</button>
                        </div>
                    </div>
                </div>
            </div>
